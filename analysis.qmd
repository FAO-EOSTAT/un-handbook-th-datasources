---
title: Big Earth Observation Data Cloud Services
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/usgs_ard_tile.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/s2_mgrs_grid.png")
```
...
#|   MGRS tiling system used by Sentinel-2 images (source: US Army).
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/landsat_wrs_grid.png")
```

## Major Global and Large Regional Cloud Providers
...
knitr::include_graphics("./images/th_data_sources/aws_s2.png")
```
...
knitr::include_graphics("./images/th_data_sources/mpc_s2.png")
```

### LANDSAT-C2-L2 Images
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/mpc_l8.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/mpc3.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/mpcrtcol.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/mpc4.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/s2_lena_delta.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/s1_rtc_cdse.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/deafrica_s2.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/landsat9_serengeti.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/alos_palsar_hh_lake_kivu.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/hls_ilhabela_s2.png") 
```
...
#| fig-align: center
knitr::include_graphics("./images/th_data_sources/world_cover_2021.png") 
```
